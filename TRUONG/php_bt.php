...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!is_numeric(isset($_POST["firstNumber"]) ? $_POST["firstNumber"] : '')) {
            $firstNumberCheck = "Please enter the number ";
        }

        if (!is_numeric(isset($_POST["lastNumber"]) ? $_POST["lastNumber"] : '')) {
    ...
    <form action="php_bt.php" method="POST">
        ...
        <div class=" form-group">
            ...
            <input type="text" name="firstNumber"
                value="<?php echo isset($_POST['firstNumber']) ?  $_POST['firstNumber'] : '';  ?>">
        ...
        <div class="form-group">
            ...
            <input type="text" name="lastNumber"
                value="<?php echo isset($_POST['lastNumber']) ?  $_POST['lastNumber'] : '';  ?>">
    ...
    <p>Result:
        <?php echo isset($firstNumberErr) || isset($lastNumberErr) || isset($lastNumberCheck) || isset($lastNumberCheck)  ? 0 :  $rs_op  ?>
    </p>
    ...
    <div class=" form-b3-container">
        ...
        <form action="php_bt.php" method="post" class="form-b3">
            <div class="form-group">
                ...
                <textarea placeholder="" class="input_text" name="input_text"
                    style="width: 100%;"> <?php echo $input_text; ?></textarea>
            </div>
            <div class="form-group center " style="display: flex; position:relative; top:10px; justify-content:center;">
                <label for="">Find: </label>
                <input type="text" name="find_text" value="<?php echo $find_text ?>"
            ...
            <div class=" form-group">
                ...
                <textarea placeholder="" class="output_text" name="output_text"
                    style="width: 100%;"><?php echo $output_text; ?></textarea>
            </div>
